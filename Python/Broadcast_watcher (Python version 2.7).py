...
Update                  : Updated the regAdd function for passing argument values to the registry value (SetValueEx).
Version                 : 4.1
...
def sendOffice365smtp(msgText):
    ...
    message = "Subject: {}\n\n{}".format(subject, msgText)
    server.sendmail("support@contoso.com", "support@contoso.com", message)
    server.quit()
